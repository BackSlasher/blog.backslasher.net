...
some reoprts that come included with SCOM [(google to find out
how)](http://www.google.co.il/search?q=scom+reports).  
...
or you can use AdtAdmin.exe from your SCOM installation media
(acs\\i386\\AdtAdmin.exe) and parse it's input with PowerShell thusly:  
