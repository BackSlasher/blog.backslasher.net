...
3](http://gallery.menalto.com/), and one of my goals was tight Facebook
...
<span style="font-size: large;">Facebook's URL Linter</span>  
Whenever you want to test / troubleshoot your shared URLs, use [this
tool](http://developers.facebook.com/tools/lint) to see what Facebook
...
<span style="font-size: large;">Metadata tags</span>  
...
<span style="font-size: large;">Open Graph Tags</span>  
