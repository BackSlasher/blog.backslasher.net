...
<span style="font-size: large;">Background story</span>  
<span style="font-size: large;"></span><span
style="font-size: small;">We've made groups for our helpdesk teams, and
...
we've set each helpdesk</span>team leader as its group's "managed by",
with the additional "Manager can update membership list" (translates to
an ACE on the group).  

<div class="separator" style="clear: both; text-align: center;">

[![](http://2.bp.blogspot.com/_5WsLrcZggrY/TRI7V83HksI/AAAAAAAAAvQ/SiimnK9ZVZs/s320/Group.png)](http://2.bp.blogspot.com/_5WsLrcZggrY/TRI7V83HksI/AAAAAAAAAvQ/SiimnK9ZVZs/s1600/Group.png)

</div>

  
The problem was that every other day, the team leader called and
...
(KB817433)](http://support.microsoft.com/kb/817433), that describes some
...
these objects' ACLs are identical to the ACL of the object  
...
 and if not, it resets the objects' ACLs (and disables security
