...
## Context
I wrote [a post](|filename|putting-your-windows-to-sleep.md) about sleep. Basically, sleep is a middle ground between saving power (by turning off components) and staying ready to work in short notice (by keeping RAM alive).  
...
The API I found for this is [SetThreadExecutionState](<https://msdn.microsoft.com/en-us/library/windows/desktop/aa373208(v=vs.85).aspx>), which can be used [like this](http://stackoverflow.com/a/6302309).  
I had my work practically done by [Stefan Stranger](https://github.com/stefanstranger) in [SuspendPowerPlan.ps1](https://github.com/stefanstranger/PowerShell/blob/master/Examples/SuspendPowerPlan.ps1), to which I added a "main" behaviour [like here](http://stackoverflow.com/q/22310114) that defaults to running the method doing nothing.  
