...
refreshing.  
After some quick Googling I found [kb842127](http://support.microsoft.com/kb/842127), which says that PTR records with uppercase characters in the host name can't be deleted.  
