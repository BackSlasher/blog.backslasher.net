...
![](|filename|/images/remotely-changing-dns-server-list/NoLogonServers.gif)
...
![](|filename|/images/remotely-changing-dns-server-list/RemoteRegedit.png)
...
![](|filename|/images/remotely-changing-dns-server-list/TCPRegistry.png)
