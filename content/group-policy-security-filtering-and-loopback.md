...
![](images/group-policy-security-filtering-and-loopback/GPSecFiltering.png)

Otherwise, the GP will show up as not applied due to it being
"inaccessible":  

![](images/group-policy-security-filtering-and-loopback/GPInaccessible.PNG)
...
- Grant Read permissions through the "Delegation" tab:
    ...
    ![](images/group-policy-security-filtering-and-loopback/GPDelegation1.png)
...
-  Add the computers to the `security filtering` (only if the GP has no
    ...
    ![](images/group-policy-security-filtering-and-loopback/GPDelegation2.png)
