...
![](/assets/reverse-lookup-in-sharepoint-2010/RLookup1.png)  
![](/assets/reverse-lookup-in-sharepoint-2010/RLookup2.png)  
--------------------------------------

You now create a lookup column in the "Books" list that contains the
bookshelf that the book belongs to. That's easy:  
![](/assets/reverse-lookup-in-sharepoint-2010/RLookup3.png)  
![](/assets/reverse-lookup-in-sharepoint-2010/RLookup4.png)  
-------------------------------------------------------------
...
bookshelf)  
![](/assets/reverse-lookup-in-sharepoint-2010/RLookup5.png)  
...
column, like this:  
![](/assets/reverse-lookup-in-sharepoint-2010/RLookup6.png)  
![](/assets/reverse-lookup-in-sharepoint-2010/RLookup7.png)  
-------------------------------------------------------------
...
![](/assets/reverse-lookup-in-sharepoint-2010/RLookup8.png)  
![](/assets/reverse-lookup-in-sharepoint-2010/RLookup9.png)  
![](/assets/reverse-lookup-in-sharepoint-2010/RLookup10.png)  
...
![](/assets/reverse-lookup-in-sharepoint-2010/RLookup11.png)  
