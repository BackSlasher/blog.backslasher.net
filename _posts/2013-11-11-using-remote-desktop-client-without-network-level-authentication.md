...
![](/assets/using-remote-desktop-client-without-network-level-authentication/RDPwithoutNLA1.png)
  
but in order to avoid using it completely, you have to save your
connection as an RDP file using "Save As":  

![](/assets/using-remote-desktop-client-without-network-level-authentication/RDPwithoutNLA2.png)
