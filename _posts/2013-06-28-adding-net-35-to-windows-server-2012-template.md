...
![AA](/assets/adding-net-35-to-windows-server-2012/AddNet1.png)
...
3.  Add the feature and immediately remove it
	...
	![Step 2](/assets/adding-net-35-to-windows-server-2012/AddNet2.png)
...
4.  Restart the machine, e.g. using `Restart-Computer` and verify:
    ...
    ![Step 3](/assets/adding-net-35-to-windows-server-2012/AddNet3.png)
