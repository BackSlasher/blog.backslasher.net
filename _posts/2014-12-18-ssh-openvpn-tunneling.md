...
* SSH, which has TCP tunneling over it's secure channel ([amongst its weponary](/assets/ssh-openvpn-tunneling/inquisition.jpg))
...
![](/assets/ssh-openvpn-tunneling/diag-openvpn.jpg)
...
![](/assets/ssh-openvpn-tunneling/diag-ssh.jpg)
