...
![](/assets/filtering-windows-event-log-using-xpath/EventFilterUI.png)
...
![](/assets/filtering-windows-event-log-using-xpath/16384Text.png)
...
![](/assets/filtering-windows-event-log-using-xpath/16384Friendly.png)

![](/assets/filtering-windows-event-log-using-xpath/16384Xml.png)

Also available are the general event details (computer name, event ID,
time generated), under the "System" Node:  

![](/assets/filtering-windows-event-log-using-xpath/16384SystemXml.png)
...
![](/assets/filtering-windows-event-log-using-xpath/SomeFilterUI.png)

And switch to the `XML` view:  

![](/assets/filtering-windows-event-log-using-xpath/SomeFilterXml.png)
...
![](/assets/filtering-windows-event-log-using-xpath/4624ProcessID.png)
