...
![](/assets/artifacts-jenkins-authentication/jenkins-ui1.png)  
<!-- PELICAN_END_SUMMARY -->
I saw other people on the internet manually downloading their results via the web UI:  
![](/assets/artifacts-jenkins-authentication/jenkins-ui2.png)  
...
![](/assets/artifacts-jenkins-authentication/http-auth.png)  
