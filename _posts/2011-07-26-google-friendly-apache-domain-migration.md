...
site
Make sure [mod\_rewrite](http://httpd.apache.org/docs/2.2/mod/mod_rewrite.html) is
...
This will cause `mod_rewrite` to redirect all requests to the new domain,
...
If you haven't done so already, add both sites to [Google Webmaster Tools](http://www.google.com/webmasters/tools/) (it's free!) and
...
db has updated.  
`.htaccess` code taken from [StackOverflow](http://stackoverflow.com/questions/6531188/old-to-new-301-redirect-parameters-for-better-google-migration)  
Happy migrating!
