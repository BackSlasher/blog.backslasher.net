...
![](/assets/setting-up-gargoyle-as-time-server/gargoyle-time-settings.png)
...
![](/assets/setting-up-gargoyle-as-time-server/gargoyle-ntp-working.png)
...
![](/assets/setting-up-gargoyle-as-time-server/debian-ntp-config.png)
...
![](/assets/setting-up-gargoyle-as-time-server/debian-time-ok.png)
