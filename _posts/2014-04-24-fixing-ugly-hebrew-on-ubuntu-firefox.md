...
![](/assets/fixing-ugly-hebrew-on-ubuntu-firefox/ff-hebrew-ugly.png)

<!-- PELICAN_END_SUMMARY -->Let's check which fonts Ynet asks to be viewed in:  

![](/assets/fixing-ugly-hebrew-on-ubuntu-firefox/ff-ynet-david.png)
...
![](/assets/fixing-ugly-hebrew-on-ubuntu-firefox/ff-hebrew-nice.png)
