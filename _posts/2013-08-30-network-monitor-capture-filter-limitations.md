...
![](/assets/network-monitor-capture-filter/NetMonRetransmit.png)  
...
![](/assets/network-monitor-capture-filter/NetMonFilter.png)  
...
![](/assets/network-monitor-capture-filter/NetMonTCPDefinition.png)
