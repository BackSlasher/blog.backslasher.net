...
![](/assets/putting-your-windows-to-sleep/PowerZoe.jpg)
...
![](/assets/putting-your-windows-to-sleep/PowerEnergyReport.png)
...
![](/assets/putting-your-windows-to-sleep/PowerSleepGP.png)
...
- Windows is Busy  
  ...
  Current requests can be viewed using `PowerCfg -requests` and they look a little like this:  
    ...
    ![](/assets/putting-your-windows-to-sleep/PowerRequests.png)
